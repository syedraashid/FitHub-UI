    ...
    <div
      ...
      <div
        ...
        <button
            ...
            <p v-if="!IsSigninClicked" class="mt-6 text-center text-sm text-gray-400">
              Ready to start your journey?
              <span  @click="()=> IsSigninClicked = !IsSigninClicked" class="cursor-pointer text-purple-500 hover:text-purple-400 font-bold">Join the elite</span>
            </p>
            <p v-else class="mt-6 text-center text-sm text-gray-400">
              Already have an account?
              <span  @click="()=> IsSigninClicked = !IsSigninClicked" class=" cursor-pointer text-purple-500 hover:text-purple-400 font-bold"
                >Log In</span>
            </p>
      </div>
    </div>
